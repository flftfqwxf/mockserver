...
window.html2canvas = function(nodeList, options) {
    ...
    options.imageTimeout = typeof(options.imageTimeout) === "undefined" ? 20000 : options.imageTimeout;
...
function createProxyUrl(proxyUrl, src, callback) {
    return proxyUrl + "?file=" + encodeURIComponent(src) + (callback.length ? "&callback=html2canvas.proxy." + callback : "")
    +"&m=" + new Date().getTime();
}
