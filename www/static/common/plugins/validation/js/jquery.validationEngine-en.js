        ...
        newLang: function() {
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "The field must not be null",
                    "alertTextCheckboxMultiple": "Choose at least one of these checkboxes",
                    "alertTextCheckboxe": "This is  mandatory ",
                ...
                "url": {
                    ...
                    "alertText": "The URL is malformed"
                },
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
                    "alertText": "只能填写数字"
                ...
                "md8": {
                    "regex": /^\d{1,8}$/,
                    "alertText": "The filed must is number, the minimum length is 1 and  the maximum length is 8"
                },
                "d15": {
                    "regex": /^\d{0,15}$/,
