    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
                ...
                // add by wuxing 2015-3-14 实现图片上传控件的监听事件
                (id=='upload') && editor.fireEvent("afterUploaded", list);
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                imageMaxNum = editor.getOpt('imageMaxNum'),
            ...
            uploader.on('beforeFileQueued', function (file) {
                var stats = uploader.getStats();
                if (stats.queueNum + stats.successNum > imageMaxNum - 1) {
                	$info.text("您一次最多只能上传"+imageMaxNum+"张图片");
                	return false;
                }
            });
            ...
            uploader.on('fileDequeued', function (file) {
            	if (file.statusText !== 'exceed_size' && (file.ext && acceptExtensions.indexOf(file.ext.toLowerCase()) != -1)) {
            		fileCount--;
                    fileSize -= file.size;
            	}
            ...
            uploader.on('filesQueued', function (files) {
                ...
                if (files.length != imageMaxNum && files.length != 0) {
                	updateTotalProgress();
                }
            });
