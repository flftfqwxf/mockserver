    ...
    $.fn[pluginName] = function(options){
        ...
        var pagination = {
            ...
            render: function(isBoot){
                ...
                if(totalPage <= 1 && attributes.hideWhenLessThanOnePage){
                	el.empty().hide();
                	return el;
                }
            ...
            go: function(number, callback){
                ...
                formatAjaxParams.success = function(response){
                    if(attributes.getTotalPageByResponse)
                    	model.totalPage = attributes.getTotalPageByResponse(response);
            ...
            filterDataByLocator: function(dataSource){
                ...
                if(Helpers.isObject(dataSource) && !Helpers.isArray(dataSource)){
